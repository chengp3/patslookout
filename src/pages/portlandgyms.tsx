  ...
  return (
    <main id="gyms" className="max-w-sm md:max-w-xl p-10 flex flex-col items-center">
      <AnimatedContainer className="flex flex-col w-full saturate-100 drop-shadow-2xl">
        ...
        <li>Clientele: 20s-40s yuppies</li>
        </AnimatedDiv>
        ...
        <div className=""><br /><b>PRG Not-Beaverton:</b> centrally located and easy to get to. Slightly older materials, but still clean. Not quite wide open spacious but plenty of room. I climbed here for a year and didn't realize there was even a fitness area. There <i>is</i> a hangboard but overall not what you come here for :p</div>
        <li>B.Y.O.Rope TR and lead. There are a few auto-belays and they are <i>fun</i>. Permanent plaster cracks that vary from fingers to hands and are super fun if that's your <i>jam</i> (lol). Setting, both boulders and ropes, is outdoor-esque.</li>
        ...
        <div><br/><b>Circuit SW:</b> Small workout area. Don't hit your head on the ceiling plumbing! Holds are slightly glassy, maybe 2.5/10. Setting tends to be comp-style. Staff is always super chill. Like possibly unnaturally chill hehehe. Great music. I live a mile away so I'm here all the time but I can't really recommend this one, all else equal, unless you live nearby or are looking for the most recent new set.</div>
        ...
        <div className="py-5 border-t"><b>Jan. 3, '24:</b> Took a visit to Skyhook yesterday (the new gym opening March 2024 in Ladd's Addition). Here is the <a href='/skyhook' className='sky-link'>sneak preview</a> of that gym. </div>
        <div className="pb-5"><b>Other Show Notes:</b> I've been to Rock Haven, the new Gresham gym, twice but only to judge kid's competitions. Looked fairly spacious and clean. I've also been to Stoneworks to drop something off, and it looked really dark and cramped, like a gym from a bygone era. The Source in Vancouver and Multnomah Athletic Club both seem to have strong kids' teams.</div>
        <div className="pb-5"><b>My wishlist:</b> One thing that I genuinely miss from any of these Portland gyms is a lounge area where one can bang out some boulders in between lines of code or Zoom meetings. Also, would love some of the older gyms to upgrade their lighting! The PNW Winters are dark enough. </div>
