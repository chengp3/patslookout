  ...
  return (
    <main id="flow" className="flex flex-col max-w-2xl my-10">
      <AnimatedContainer className="mb-10 contents w-full flex">
        ...
        <AnimatedDiv className="w-full flex justify-center">
          <img className="border-t-2 border-l-2 border-b-2 border-black max-w-xs" src="https://patslookout.s3.us-west-2.amazonaws.com/flow/figure+2.png" />
          <img className="border-2 border-black max-w-xs" src="https://patslookout.s3.us-west-2.amazonaws.com/flow/figure+3a.png" />
        </AnimatedDiv>
        ...
        <AnimatedDiv className="w-full flex justify-center">
          <img className="border-2 border-black max-w-xs" src="https://patslookout.s3.us-west-2.amazonaws.com/flow/figure+4.png" />
        </AnimatedDiv>
        ...
        <AnimatedDiv className="w-full flex justify-center">
          <img className="border-2 border-black max-w-lg" src="https://patslookout.s3.us-west-2.amazonaws.com/flow/figure+5.png" />
        </AnimatedDiv>
        ...
        <AnimatedDiv className="w-full flex justify-center">
          <img className="border-2 border-black max-w-lg" src="https://patslookout.s3.us-west-2.amazonaws.com/flow/figure+6.png" />
        </AnimatedDiv>
        ...
        <AnimatedDiv className="w-full flex justify-center">
          <img className="border-2 border-black max-w-lg" src="https://patslookout.s3.us-west-2.amazonaws.com/flow/figure+7.png" />
        </AnimatedDiv>
        ...
        <AnimatedDiv className="w-full flex justify-center">
          <img className="border-2 border-black max-w-lg" src="https://patslookout.s3.us-west-2.amazonaws.com/flow/figure+8.png" />
        </AnimatedDiv>
        ...
        <AnimatedDiv className="w-full flex justify-center">
          <img className="border-2 border-black max-w-lg" src="https://patslookout.s3.us-west-2.amazonaws.com/flow/figure+9.png" />
        </AnimatedDiv>
        ...
        <AnimatedDiv className="w-full flex justify-center">
          <img className="border-2 border-black max-w-lg" src="https://patslookout.s3.us-west-2.amazonaws.com/flow/figure+10.png" />
        </AnimatedDiv>
        ...
        <AnimatedDiv className="w-full flex justify-center">
          <img className="border-2 border-black max-w-xl" src="https://patslookout.s3.us-west-2.amazonaws.com/flow/figure+11.png" />
        </AnimatedDiv>
        ...
        <AnimatedDiv className="w-full flex justify-center">
          <img className="border-2 border-black max-w-xl" src="https://patslookout.s3.us-west-2.amazonaws.com/flow/figure+12.png" />
        </AnimatedDiv>
