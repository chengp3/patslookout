  ...
  return (
    <main id="gyms" className="max-w-sm md:max-w-xl p-10 flex flex-col items-center">
      <AnimatedContainer className="flex flex-col w-full saturate-100 drop-shadow-2xl">
        ...
        <li>B.Y.O.Rope TR and lead. There are a few auto-belays and they are <i>fun</i>. Permanent plaster cracks that vary from fingers to hands and are super fun if that's your <i>jam</i> (haha). Setting, both boulders and ropes, is outdoor-esque.</li>
