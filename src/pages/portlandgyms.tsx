  ...
  return (
    <main id="gyms" className="max-w-sm md:max-w-xl p-10 flex flex-col items-center">
      <AnimatedContainer className="flex flex-col w-full saturate-100 drop-shadow-2xl">
        ...
        <li>30m routes, mostly leadable. Every route can be toproped with a prehung rope and grigri. No auto belays.</li>
        <li>The routes seem to focus on a particular hold/movement style.  Boulder setting is a pretty even mix of comp style, burl, and tech.</li>
        ...
        <div><br/><b>Circuit Northwest:</b> Large space. Holds are probably the most polished in all of Portland, which is to say maybe 4/10 where 10 is the bad side of a dual-tex hold. My friends frequently say the setting is more enjoyable than SW; I personally feel it is less compy in general. Will be sharing this one with kids during after-school hours.</div>
